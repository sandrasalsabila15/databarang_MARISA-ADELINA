...
class UpdateDataActivity : AppCompatActivity() {
    ...
    fun actionData(id : String, namaBarang : String, jumlahBarang : String ){
        koneksi.service.updateBarang(id, namaBarang, jumlahBarang).enqueue(object : Callback<ResponseActionBarang>{
